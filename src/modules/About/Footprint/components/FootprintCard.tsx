...
const FootprintCardContent = memo(function FootprintCardContent({
  footprint,
}: FootprintCardProps) {
...
export default function FootprintCard({ footprint }: FootprintCardProps) {
  if (!footprint.link) return <FootprintCardContent footprint={footprint} />
  return (
    <Link href={footprint.link} target="_blank">
      <FootprintCardContent footprint={footprint} />
    </Link>
  )
}
