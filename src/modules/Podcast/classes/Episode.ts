...
export class Episode {
  ...
  constructor (private params: GetEpisodeResponse['data']['data']) {
    ...
    this.description = isString(params.description) ? params.description : undefined
    this.complete = isBoolean(params.complete) ? params.complete : undefined
    this.publishDate = isString(params.publishDate) ? params.publishDate : undefined
    this.itunesKeywords = isArray(params.itunesKeywords) ? params.itunesKeywords : undefined
    ...
    this.artistName = isString(params.artistName) ? params.artistName : undefined
    ...
    this.contentEncoded = isString(params.contentEncoded) ? params.contentEncoded : undefined
    ...
    this.episodeType = isString(params.episodeType) ? params.episodeType : undefined
    this.exclusiveType = isString(params.exclusiveType) ? params.exclusiveType : undefined
